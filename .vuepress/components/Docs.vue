                            ...
                            <b-card no-body
                                ...
                                <b-list-group flush>
                                    <b-list-group-item class="py-4">
                                        <b-link :href="`https://github.com/mineyourbiz/bep20-generator/blob/v${token.version}/dist/${contracts.token.contractName}.dist.sol`"
                                                target="_blank">
                                            <b-img :src="`https://img.shields.io/badge/version-${token.version}-blue`"></b-img>
                                        </b-link>
                                        <b-link href="https://github.com/mineyourbiz/bep20-generator/actions" target="_blank">
                                            <b-img src="https://github.com/mineyourbiz/bep20-generator/workflows/CI/badge.svg?branch=master"></b-img>
                                        </b-link>
                                        <b-link href="https://coveralls.io/github/mineyourbiz/bep20-generator?branch=master" target="_blank">
                                            <b-img src="https://coveralls.io/repos/github/mineyourbiz/bep20-generator/badge.svg?branch=master"></b-img>
                                        </b-link>
                                        <b-link href="https://github.com/mineyourbiz/bep20-generator/blob/master/LICENSE" target="_blank">
                                            <b-img src="https://img.shields.io/github/license/mineyourbiz/bep20-generator.svg"></b-img>
                                        </b-link>
                                    </b-list-group-item>
                                    <b-list-group-item class="py-4">
                            ...
                            <b-card no-body
                                ...
                                <b-list-group flush>
                                    ...
                                    <b-list-group-item class="d-flex justify-content-between align-items-center">
                                        ...
                                        <b-badge :variant="token.supplyType === 'Capped' ? 'success' : (token.supplyType === 'Unlimited' ? 'info' : (token.supplyType === 'Fixed' ? 'warning' : 'danger'))">
                                            {{ token.supplyType }}
                                        </b-badge>
                                    </b-list-group-item>
  ...
  export default {
    ...
    computed: {
      controlFlow: function () {
        return `https://github.com/mineyourbiz/bep20-generator/blob/v${this.token.version}/analysis/control-flow/${this.contracts.token.contractName}.png`;
      },
      inheritanceTree: function () {
        return `https://github.com/mineyourbiz/bep20-generator/blob/v${this.token.version}/analysis/inheritance-tree/${this.contracts.token.contractName}.png`;
      },
      uml: function () {
        return `https://github.com/mineyourbiz/bep20-generator/blob/v${this.token.version}/analysis/uml/${this.contracts.token.contractName}.svg`;
      },
    },
    mounted () {
      this.initDapp();
